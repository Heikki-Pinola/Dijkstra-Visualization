...
\node[state] (2) [below =of 1, yshift=-10] {2};
...
\foreach \i [count=\j from 0] in {0, 10, 5, $\infty$, $\infty$, $\infty$}
...
\node[state, label=right: $\infty$] (3) at (-1,1) {3};
\node[state, label=right: $\infty$] (5) at (1,2) {5};
%\node[state, label=right: 10] (1) at (-1,1) {1};
\node[state, label=right: 10] (1) at (0,-0.5) {1};
\node[state, label=right: $\infty$] (4) at (1,1) {4};
